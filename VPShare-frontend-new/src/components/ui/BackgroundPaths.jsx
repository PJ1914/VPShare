...
const FloatingPaths = memo(({ position }) => {
    const paths = useMemo(() => Array.from({ length: 20 }, (_, i) => ({
        id: i,
        d: `M-${380 - i * 5 * position} -${339 + i * 6}C-${380 - i * 5 * position
            } -${339 + i * 6} -${312 - i * 5 * position} ${66 - i * 6} ${152 - i * 5 * position
            } ${193 - i * 6}C${616 - i * 5 * position} ${320 - i * 6} ${684 - i * 5 * position
            } ${725 - i * 6} ${684 - i * 5 * position} ${725 - i * 6}`,
