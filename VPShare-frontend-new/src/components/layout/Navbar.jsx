                                    ...
                                    >
                                        {active && (
                                            <motion.div
                                                ...
                                                className="absolute inset-0 bg-blue-100 dark:bg-blue-900/40 rounded-full -z-10 translate-x-1"
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed top-0 left-0 bottom-0 w-[280px] bg-white dark:bg-gray-950 shadow-2xl z-[70] md:hidden border-r border-gray-200 dark:border-gray-800 flex flex-col"
                        >
                            {/* Drawer Header */}
