...
function AdminPanel() {
  ...
  useEffect(() => {
    ...
    if (currentUser) {
      ...
      const adminEmails = ['admin@codetapasya.com', 'pranay.jumbarthi1905@gmail.com', 'yelsanimahalaxmi@gmail.com', 'vishnutej49@gmail.com', 'swathi.badrinaryanan@gmail.com', 'macherlarohith2004@gmail.com', 'javajiharshithapriya@gmail.com'];
      ...
      <div className="welcome-banner">
        <div className="welcome-content">
          <div className="max-w-3xl">
            <h2>Admin Panel - Code Tapasya 👋</h2>
